#Asking what the user wants to do.  play or use the calculator 
whattodo = input("What would you like to do? Play Tic Tac Toe against the computer (1) or use the calculator?(2) ")
if whattodo == ("1"):
    import random
    board = [["1","2","3"],
            ["4","5","6"],
            ...
            while not gameWon:
                                 ...
                                 if computerplayHappened == False:
                                     for X in range (0,3):  #Finding out if it has two "X"s in a column to then take the last square if there isn't already a nought
                                         ...
                                         if CountY == 2 and SpaceRow < 3:
                                             setPos(SpaceRow,X,"X")
                                             computerplayHappened = True
                                #blocking the person from 3 in a row
                ...
                #Otherwise, we need to check if there are any free spaces
                    ...
                    if not vacantSquare and not gameWon:
                        ...
                        displayBoard()
if whattodo == ("2"):
    operatortodo = input("What operator would you like to use? (addition/subtraction/multipication/division)")
    if operatortodo == ("+"):
